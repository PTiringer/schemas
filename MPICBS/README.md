...
```sh
git clone https://github.com/PTiringer/MPICBS.git
cd MPICBS
...
| Name | E-mail     |
|------|------------|
| Peter Tiringer | [peter.tiringer@uni-jena.de](mailto:peter.tiringer@uni-jena.de)
